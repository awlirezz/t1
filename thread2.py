...
tk.Label(root,
         cnf=l_cnf,
         text='Right Player',
         font=('times', 20, 'italic')).grid(row=0, column=2)
...
tk.Label(root,
         ...
         font=('courier', 20)).grid(row=1, column=2)
...
tk.Button(root,
          ...
          font=('times', 20)).grid(row=2, column=0, sticky=tk.W)
tk.Button(root,
          cnf=b_cnf,
          text='Stop',
          command=lambda: stop('right'),
          font=('times', 20)).grid(row=2, column=2, sticky=tk.E)
time_value = tk.IntVar()
tk.Entry(root,
         textvariable=time_value,
         font=('times', 20)).grid(row=3, column=0, columnspan=3, sticky=tk.E)

tk.Button(root,
          cnf=b_cnf,
          text='Start',
          command=begin,
          font=('times', 20)).grid(row=3, column=2, sticky=tk.E)

tk.Button(root,
          cnf=b_cnf,
          text='Cancel',
          command=root.destroy,
          font=('times', 20)).grid(row=5, column=0, columnspan=3, sticky=tk.W + tk.E)
###################################################################################################
